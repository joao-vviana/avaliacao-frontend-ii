const form = document.getElementById("form_lista") as HTMLFormElement;
const tabela = document.getElementById("tbody") as HTMLTableElement;
...
function pegarRecadosDoLocalStorage (): Array<IRecado>{
    return JSON.parse(localStorage.getItem("recados") ?? "[]")
}

function salvarRecadosDoLocalStorage(data: Array<IRecado>) {
